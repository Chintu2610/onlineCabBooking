...
<head>
    ...
    <title>PayZigo -Settlement  Report</title>
 ...
 <div class="white-smoke-background">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <h3 class="page-title">Settlement  Report</h3>
    ...
    <form action="search_logs.jsp" method="get">
     ...
     <label>Search by UTR / RefID <span class="text-danger">*</span></label>
...
<br><br><br><br>
    <div class="col-sm-6 col-md-3">
        ...
        <select class="input" style="width: 120px;height: 28px;" name="" id="">
            ...
            <option>NEFT</option>
             <option>RTGS</option>
             <option>Account Validation</option>
        </select>
         </div>
                </div>
            <div class="col-sm-6 col-md-3">
        ...
        <br>
            <div class="col-sm-6 col-md-3">
        <div class="form-group">
     <label for="">Select SettlementType:</label>
        <select class="input" style="width: 120px;height: 28px;" name="" id="">
            <option>Payout1</option>
            <option>Payout2</option>
            <option>Payout3</option>
        </select>
         </div>
                </div>
       ...
       <label for="Entries">Top Entries:</label>
        <select class="input" style="width: 120px;height: 28px;" name="Entries" id="Entries">
            ...
            <option>100</option>
                 ...
                 <br>  <br>  <br>  <br>
        <div class="col-sm-6 col-md-3">
        <div class="container1" class="form-group">
