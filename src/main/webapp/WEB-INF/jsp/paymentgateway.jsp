...
<head>
    ...
    <title>PayZigo - Payment Gateway</title>
...
<%@ include file="sidebar.jsp" %>
 ...
 <div class="white-smoke-background">
    ...
    <form action="search_logs.jsp" method="get">
     ...
     <label>OrderID / RefID / Payment ID <span class="text-danger">*</span></label>
   ...
   <div class="col-sm-6 col-md-3">
      ...
      <label for="Source">Source:</label>
        <select class="input" style="width: 120px;height: 28px;" name="source" id="Source">
          ...
          <div class="col-sm-6 col-md-3">
        <div class="form-group"> 
      <label for="">Select PaymentType:</label>
        <select class="input" style="width: 120px;height: 28px;" name="" id="">
            <option>ALL</option>
            <option>PAYMENTGATEWAY-1</option>
            <option>PAYMENTGATEWAY-2</option>
             <option>PAYMENTGATEWAY-3</option>
             <option>PAYMENTGATEWAY-4</option>
        </select>
    </div>        
    </div>
