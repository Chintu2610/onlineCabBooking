...
<head>
    ...
    <title>PayZigo - Login Logs</title>
...
<div class="col-sm-6 col-md-3">
        ...
        <div class="col-sm-6 col-md-3">
        <div class="form-group">
        <label for="Entries">Top Entries:</label><br>
        <select class="input" style="width: 120px;height: 28px;padding: 10px;height: 20px;" name="Entries" id="Entries">
            <option>10</option>
            <option>25</option>
            <option>50</option>
            <option>100</option>
    ...
    <table>
        ...
        <tbody>
            <!-- Table rows will be dynamically populated here based on search results -->
        </tbody>
    </table>
 </div>
