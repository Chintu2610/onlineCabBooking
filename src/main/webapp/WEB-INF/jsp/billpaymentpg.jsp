  ...
  <div class="white-smoke-background">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <h3 class="page-title">BillPayment PG Transactions</h3>
						<!-- <ul class="breadcrumb">
							<li class="breadcrumb-item"><a href="index.jsp">Dashboard</a></li>
							<li class="breadcrumb-item active">BillPayment PG Transactions</li>
						</ul> -->
                    </div>
    ...
    <form action="search_logs.jsp" method="get">
     ...
     <label>Search by OrderID / RefID / Payment ID <span class="text-danger">*</span></label>
