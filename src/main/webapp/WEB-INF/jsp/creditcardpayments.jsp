 ...
 <div class="white-smoke-background">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <h3 class="page-title">CreditCard Payments</h3>
					<!-- 	<ul class="breadcrumb">
							<li class="breadcrumb-item"><a href="index.jsp">Dashboard</a></li>
							<li class="breadcrumb-item active">CreditCard Payments</li>
						</ul> -->
                    </div>
    ...
    <form action="search_logs.jsp" method="get">
     ...
     <label>Search by RefID / AckNo <span class="text-danger">*</span></label>
 ...
 <div class="col-sm-6 col-md-3">
   ...
   <label for="">Select PaymentType:</label>
        <select class="input" style="width: 120px;height: 28px;" name="" id="">
            <option>ALL</option>
            <option>CCPayments-1</option>
            <option>CCPayments-2</option>
        </select>
    </div>
            </div>
            <br>
