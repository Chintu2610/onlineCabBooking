...
<head>
    ...
    <title>PayZigo - Customer BillPayments</title>
 ...
 <div class="white-smoke-background">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <h3 class="page-title">Customer BillPayments</h3>
						<ul class="breadcrumb">
							<li class="breadcrumb-item"><a href="index.jsp">Dashboard</a></li>
							<li class="breadcrumb-item active">Customer BillPayments</li>
						</ul>
                    </div>
    ...
    <form action="search_logs.jsp" method="get">
     ...
     <label>Search by ReffID <span class="text-danger">*</span></label>
        <input name="" class="form-control" type="">
            ...
            <div class="col-sm-6 col-md-3">
        <div class="form-group">
       <label>Search by UniqueID <span class="text-danger">*</span></label>
        <input name="" class="form-control" type="">
          </div>        
    </div>
