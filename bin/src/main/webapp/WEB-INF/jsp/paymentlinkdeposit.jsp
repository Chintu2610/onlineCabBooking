...
<head>
    ...
    <title>PayZigo - Payment Link Deposit</title>
 ...
 <div class="white-smoke-background">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <h3 class="page-title">Payment Link Deposit</h3>
						<!-- <ul class="breadcrumb">
							<li class="breadcrumb-item"><a href="index.jsp">Dashboard</a></li>
							<li class="breadcrumb-item active">Payment Link Deposit</li>
						</ul> -->
                    </div>
    ...
    <div class="col-sm-6 col-md-3">
     ...
     <label>UTR / RefID / PaymentLink ID <span class="text-danger">*</span></label>
...
<br>
 ...
 <div class="col-sm-6 col-md-3">
      ...
      <label for="">Select Payment Mode:</label>
        ...
        <select class="input" style="width: 120px;height: 28px;" name="source" id="Source">
            <option>ALL</option>
            <option>WEB</option>
        ...
        <select class="input"  style="width: 120px;height: 28px;" name="" id="">
            <option>PaymentLink-1</option>
            <option>PaymentLink-2</option>
            <option>PaymentLink-3</option>
             <option>PaymentLink-4</option>
             <option>PaymentLink-5</option>
        </select>
            </div>        
    </div>
         <div class="col-sm-6 col-md-3">
        <div class="form-group">
            <label for="Source">Settlement Type:</label>
        <select class="input" style="width: 120px;height: 28px;" name="source" id="Source">
            <option>ALL</option>
           ...
           <div class="col-sm-6 col-md-3">
        <div class="form-group">
      <label for="Source">KYC Verification Status:</label>
        <select class="input" style="width: 120px;height: 28px;" name="source" id="Source">
            <option>ALL</option>
    ...
    <div class="col-sm-6 col-md-3">
       ...
       <label for="Entries">Top Entries:</label>
        <select class="input" class="input" style="width: 120px;height: 28px;" name="Entries" id="Entries">
            <option>10</option>
            <option>25</option>
            <option>50</option>
            <option>100</option>
